...
Auxil::lexiconToOrigin(const QString& lexicon)
{
    if (lexicon == LEXICON_CSW24)
        return "<a href=\"http://www.collinsdictionary.com/scrabble/scrabble-tools#terms\">British (© HarperCollins 2024, see T&Cs)</a>";
...
{
    if (lexicon == LEXICON_CSW24) {
        return "<a href=\"http://www.collinsdictionary.com/scrabble/scrabble-tools#terms\">The © HarperCollins 2024 word list (CSW24) "
            "is copyright of HarperCollins 2024 and used with permission.</a>";
    }
    return QString();
}
